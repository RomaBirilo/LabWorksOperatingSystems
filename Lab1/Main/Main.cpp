...
int main()
{
    ...
    getline(wcin, n);
    wstring command = L"\"D:\\Рома\\программирование\\C++\\2 grade\\Lab1\\x64\\Debug\\Creator.exe\" \"" + filename + L"\" " + n;
    ...
    wstring command_rep = L"\"D:\\Рома\\программирование\\C++\\2 grade\\Lab1\\x64\\Debug\\Reporter.exe\" \"" + 
        filename + L"\" "+ L"\"" +filename_rep+L"\" " + hourly_rate;
